...
namespace WetherApp {
    internal class Program {
        // 例：グリーンランド（緯度 59.8, 経度 83.7）の現在の気温などを取得
        private const string Url =
            "https://api.open-meteo.com/v1/forecast?latitude=15.4&longitude=47.5&current=temperature_2m,wind_speed_10m,relative_humidity_2m";
